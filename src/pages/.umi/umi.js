...
import findRoute, {
  getUrlQuery,
} from 'C:/Users/hl/AppData/Local/Yarn/Data/global/node_modules/umi-build-dev/lib/findRoute.js';
...
plugins.use(
  require('../../../node_modules/_umi-plugin-dva@1.10.1@umi-plugin-dva/lib/runtime'),
);
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('C:/Users/hl/AppData/Local/Yarn/Data/global/node_modules/umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: 'D:/reactProject/umi-test',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('C:/Users/hl/AppData/Local/Yarn/Data/global/node_modules/umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
